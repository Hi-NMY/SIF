...
public class SignInFragment extends BaseFragment {
    ...
    private Handler newSignHanlder = new Handler(){
        ...
        public void handleMessage(Message msg) {
            ...
            ToastZong.ShowToast(MyApplication.getContext(),"打卡成功");
            mLongSginDay = view.findViewById(R.id.long_sgin_day);
        ...
        for (int i = 1 ; i < mapRelative.size() + 1 ; i++){
            ...
            rel.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if ((Integer) mapImage.get((Integer) rel.getTag()).getTag() == 0){
                        ToastZong.ShowToast(MyApplication.getContext(),"不能重复打卡");
                    }else if ((Integer) mapImage.get((Integer) rel.getTag()).getTag() == 1){
                        ObtainUserSign.updateSign(myXueHao,setSign((Integer) rel.getTag()),newSignHanlder);
                        startSign((Integer) rel.getTag());
                    }else if ((Integer) mapImage.get((Integer) rel.getTag()).getTag() == 2) {
                        ToastZong.ShowToast(MyApplication.getContext(),"金币");
                    }else if ((Integer) mapImage.get((Integer) rel.getTag()).getTag() == 3) {
                        ToastZong.ShowToast(MyApplication.getContext(),"补打卡");
                    }
                }
            });
        }
    ...
    private UserSignClass userSignClass;
